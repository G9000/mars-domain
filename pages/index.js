...
export default function Home() {
    ...
    return (
      <div className="mx-auto max-w-[400px] flex flex-col gap-y-6">
        ...
        {editing ? (
          ...
          <button
            className="bg-violet-600 hover:bg-violet-800 text-white rounded-lg text-xl font-bold px-10 py-4"
            disabled={loading}
            onClick={mintDomain}
          >
        ...
        <div className="max-w-[1440px] px-4 mx-auto my-20">
          ...
          <div className="flex gap-6 mt-6">
            {mints.map((mint, index) => {
              return (
                <div className="bg-violet-100 w-[320px] rounded-lg" key={index}>
                  <div className="bg-violet-600 rounded-t-lg flex flex-col justify-center w-full p-4">
                    <a
  ...
  return (
    <div className="bg-black min-h-screen">
      <Head>
        <title>Mars domain</title>
        <meta name="description" content="Mars domain" />
      ...
      <header className="flex justify-between items-center py-10 px-4 max-w-[1440px] mx-auto">
        ...
        <div className="flex items-center">
          <div className="mr-6">
            {network.includes("Polygon") ? <PolygonLogo /> : <EthereumLogo />}
          </div>
